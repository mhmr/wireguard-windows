...
:installdeps
	...
	cd .deps || goto :error
	call :download go.zip https://download.wireguard.com/windows-toolchain/distfiles/go1.16beta1-2021-02-14.zip c1ca1e3973bae0eef7678d89bda99bd4eb447610391557163f1b0a06b14b7698 || goto :error
